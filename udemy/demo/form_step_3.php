...
<body>
	...
	<form action="form_step_3.php" method="post">
...
if(isset($_POST['submited'])) {
	...
	$min = 5;
	$max = 8;
	$names = ['Dariusz', 'Mariusz', 'Robert', 'Victor'];

	if (strlen($name) < $min) {
		echo 'Username must be min 5 charcters long';
	}
	if (strlen($name) > $max) {
		echo 'Username must be max 8 charcters long';
	}
